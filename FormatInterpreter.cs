...
namespace NDM
{
    public enum CommandType { UNKNOWN, FIN, STAT, NQUE, DQUE }

    public enum ResourceType { UNKNOWN, WEB, FTP /*, FILE, SITE */ }
    ...
    public class FormatInterpreter
    {
        ...
        {
            return new DateTime(Convert.ToInt32(s.Substring(0, 4)), Convert.ToInt32(s.Substring(4, 2)), Convert.ToInt32(s.Substring(6, 2)), Convert.ToInt32(s.Substring(8, 2)), Convert.ToInt32(s.Substring(10, 2)), Convert.ToInt32(s.Substring(12, 2)));
        }
